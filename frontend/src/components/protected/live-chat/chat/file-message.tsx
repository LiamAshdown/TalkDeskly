...
import { File, FileText, ImageIcon, Music, Package, Video } from "lucide-react";
...
export const FileMessage = ({ content, metadata }: FileMessageProps) => {
  ...
  return (
    <div className="space-y-2">
      <Card
        className="overflow-hidden p-3 flex items-center gap-3 cursor-pointer hover:bg-muted/50 transition-colors"
        onClick={handleFileClick}
      >
